...
const url  = 'https://api.themoviedb.org/4/search/movie?api_key=a0a744b143e40d6baf5ebed15d300768';
    ...
    // liens pour l'affichage de mes séries populaires
const APIURL ="  https://api.themoviedb.org/3/tv/popular?api_key=a0a744b143e40d6baf5ebed15d300768&language=fr-FRANCE&page=1";
const IMGPATH = "https://image.tmdb.org/t/p/w1280";

// c'est dans le main que mes élements vont se trouver
const display = document.getElementById("display");

// de base on affiche les séries populaires
getSerie(APIURL);
...
async function getSerie(url) {
    ...
    showSerie(respData.results);
}

function showSerie(movies) {
    // je clear mon main
    display.innerHTML = "";
